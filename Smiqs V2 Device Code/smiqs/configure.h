...
int SolenoidValve_valSensorMax = 55;
int SolenoidValve_valSensorMin = 40;

int SolenoidValve_valSensorMaxB = 50;
int SolenoidValve_valSensorMinB = 20;

int NumberOfValves=1;
int ValveNumber = 3;
int deviceMode = 1;
char* MobileNumber = "0549983841";
String MobNumber = "0549983841";
